...
import { IDL, StakingHook } from "../target/types/staking_hook";
...
describe("transfer-hook", () => {
  ...
  const programId = new PublicKey("EB9buE9e2Gwphxs6iPKyzXjqnom7vSQgDj2PGBiP7X4h");

  const program = new anchor.Program<StakingHook>(IDL, programId, provider);
  ...
  const stakingAccount = PublicKey.findProgramAddressSync([Buffer.from("staking"), mint.publicKey.toBuffer()], program.programId)[0];
